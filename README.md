...
Kinopoisk-with-fetch-dev-api is a simple web-client for kinopoisk.dev API [web](https://api.kinopoisk.dev/) [git](https://github.com/OpenMovieDB/kinopoiskdev) with javascript fetch api

Parcel Preset repository: [link](https://github.com/junproger/project-preset-with-parcel)

Kinopoisk-with-fetch-dev-api [link](https://github.com/junproger/kinopoisk-with-fetch-dev-api)
